    ...
    <div id="layout" class="h-screen w-full flex flex-col items-center gap-6 bg-[#f1f5f9]">
        ...
        >
            <div class="w-full flex justify-center items-center gap-3">
                ...
                <h1 class="capitalize text-3xl font-bol text-[#322e81]">crear usuarios</h1>
            </div>
            ...
            <a class="w-full md:hidden lg:hidden border p-3 text-white rounded-md bg-[#322e81]" href="{{route('index')}}">
                Ver todos los usuarios
            </a>
        </header>
        <main id="content" class="w-full flex flex-col gap-2 md:w-1/2 lg:w-1/5 p-2">
            ...
            >
                ...
                <div class="w-full">
                    ...
                    <input class="w-full outline-none text-[#322e81] cursor-pointer border rounded-md p-1 border-[#322e81]" type="text" 
                        name="name"
                        id="userName"
                        required
                    >
